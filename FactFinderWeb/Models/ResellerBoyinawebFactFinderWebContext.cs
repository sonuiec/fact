...
public partial class ResellerBoyinawebFactFinderWebContext : DbContext
{
    public ResellerBoyinawebFactFinderWebContext()
    {
    }

    public ResellerBoyinawebFactFinderWebContext(DbContextOptions<ResellerBoyinawebFactFinderWebContext> options)
        : base(options)
    {
    }
    ...
    public DbSet<ApplicantDataDto> ApplicantDataDto { get; set; }

    //    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    //#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    //        => optionsBuilder.UseSqlServer("Server=localhost;Database=Reseller_Boyinaweb_FactFinderWeb;TrustServerCertificate=True;user=sa;pwd=Admin123");
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        optionsBuilder.UseSqlServer("Server=103.205.142.104,1444;Database=Reseller_Boyinaweb_FactFinderWeb;TrustServerCertificate=True;user=Reseller_Boyinaweb_factfinderWebDB;pwd=8wmKwX?25xomtVai2");
    }
